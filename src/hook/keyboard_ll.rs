...
See: https://raw.githubusercontent.com/CasualX/external/master/src/hook/keyboard_ll.rs
!*/
...
// use crate::winapi::um::winuser::{SetWindowsHookExW, UnhookWindowsHookEx};
// use crate::winapi::um::winuser::{WH_KEYBOARD_LL};
...
// /// Low level keyboard hook callback context.
// ///
// /// see also: https://habr.com/ru/post/482644/
